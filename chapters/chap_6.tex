...
Similarly to \cref{sec:environments}, we define (1) How to retrieve the type of a variable, (2) What it means for a variable to be contained in a context and (3) Wow we can introduce new variables into a context. 
