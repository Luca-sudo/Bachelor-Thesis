...
\[
   ...
   \inference
   {
      ...
      {
         \typing{\Gamma;x:A;xs:\ralist{p}{A}}{\letexp{\_}{\tick{2}}{\cons{x+1}{add1~xs}}}{\ralist{}{\typeint}}
      }
   }
   {
      \typing{\Gamma;l : \ralist{p}{A}}{\listmatch{l}{\listnil}{\letexp{\_}{\tick{2}}{\cons{x+1}{add1~xs}}}}{\ralist{2}{\typeint}}
   }
\]
...
For our second example, we define a function \(sum\) that takes two inputs: The list of integers to sum over, and an accumulator. 
