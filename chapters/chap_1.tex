...
\todo{Rework entire introduction to Amortized Analysis}
...
\todo{Scrap and introduce evaluation semantic basics}
\todo{Maybe introduce basic type-related notions? Derivations, judgement, etc. for reader completely unfamiliar}
\todo{Maybe introduce idea of lean scripts?}
