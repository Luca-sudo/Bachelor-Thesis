...
Most of the time we write \(\ratype{A}{p_0}{p_1}\) for \((A, (p_0, p_1))\). For this chapter, the only type that \(A\) can adopt is \(\unit\). Therefore, resource-aware types have the form \(\ratype{\unit}{p_0}{p_1}\).
