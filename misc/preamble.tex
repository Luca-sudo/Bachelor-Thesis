...
\newcommand{\listoflength}[2]{\text{List}_{#1}(#2)}
...
\glsxtrnewsymbol[description={Function Abstraction (\cref{def:prog-lang-6})}, group={syntax}]{func abstraction}{\(\func~f~x = e_f\)}
