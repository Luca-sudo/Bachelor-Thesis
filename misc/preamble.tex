...
% Resources
\glsxtrnewsymbol
  [description={Set of resources}, group={resources}]
  {resources}
  {\resource}
\glsxtrnewsymbol
[description={Resource Demands}, group={resources}]
  {resource demands}
  {\demand}
\glsxtrnewsymbol
[description={Sequencing Operator}, group={resources}]
  {sequencing}
  {\sequence}
\glsxtrnewsymbol
  [description={Relaxation Relation}, group={resources}]
  {relaxation}
  {\relaxation}
...
\glsxtrnewsymbol
  [description={Resource-Aware Type}, group={types}]
  {ratype}
  {\(\ratype{A}{p_0}{p_1}\)}
\glsxtrnewsymbol[description={Resource-Aware Function}, group={types}]{rafunc}{\(\rafunc{A}{B}{p_0}{p_1}\)}
\glsxtrnewsymbol[description={List Type with Potential}, group={types}]{listtype}{\(\ralist{q}{A}\)}
\glsxtrnewsymbol[description={Type Context}, group={types}]{context}{\(\Gamma\)}
\glsxtrnewsymbol[description={Disjoint Contexts}, group={types}]{disjoint contexts}{\(\Gamma_1 \cap \Gamma_2 = \emptyset\)}
...
\glsxtrnewsymbol[description={Typing Judgement}, group={types}]{typejudgement}{\(\typing{\Gamma}{e}{A}\)}
